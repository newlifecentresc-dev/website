    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                style="background-image: url({{ asset('administrator/media/bg/bg-1.jpg') }});">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    <!--begin::Login Header-->
                    <div class="d-flex flex-center mb-15">
                        <a href="javascript:void(0);">
                            <img src="{{ $settings->site_logo }}" class="max-h-100px" alt="{{ $settings->site_title }}" />
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        ...
                        <form class="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group text-center mt-10">
                                <button type="submit" class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">Sign
                                    In</button>
                            </div>
                        </form>
                    </div>
